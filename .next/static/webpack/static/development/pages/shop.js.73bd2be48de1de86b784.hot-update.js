...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Shop, [{
    ...
    value: function componentDidMount() {
      ...
      //   // console.log(name);
      // });
      isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_7___default()("https://another-test-store-97213.myshopify.com/api/graphql", {
        method: "post",
        headers: {
          "Content-Type": "application/graphql",
          "X-Shopify-Storefront-Access-Token": "5db76a7bcd70717eade01e6a64392829"
        },
        body: _queries_shop_js__WEBPACK_IMPORTED_MODULE_8__["default"].getProductsWithImages(1)
      }).then(function (r) {
        return r.json();
      }).then(function (data) {
...
//# sourceMappingURL=shop.js.73bd2be48de1de86b784.hot-update.js.map